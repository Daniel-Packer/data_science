...
print(f.get_features(game))

#print(f.knight_features(game))
#print(f.bishop_features(game))
#print(f.minor_features(game))
#print(f.rook_features(game))
#print(f.queen_features(game))
#print(f.white_development(game))
#print(f.white_castling(game))
#print(f.white_pawns(game))
#print(f.white_board(game))
#print(f.white_clusters(game))
#print(f.discovered_checks(game))
#print(f.distribution_piece_moves(game))
#print(f.pins(game))
#print(f.forks(game))
#print(f.pieces_guarded(game))
#print(f.trades(game))
#print(f.exchanges_possible(game))
#print(f.king_squares_attacked(game))
#print(f.king_safety(game))
